...
export function SpotlightCard({ as: Component = 'div', from = 'rgba(255,255,255,0.8)', via = null, to = 'transparent', size = 350, mode = 'before', hsl = false, hslMin = 0, hslMax = 360, children, className, ...props }) {
